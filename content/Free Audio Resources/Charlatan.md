...
URL: http://www.blaukraut.info/
Image: charlatan2.png
Date Added: 2022-04-21 15:03:00
Tags:
  - instrument
🌟: false
Last Edited: 2022-04-21 16:47:00
---
...
(*) Due to some tweaks to the sound engine, there may be subtle audible differences when loading some of the old patches. In most cases, it should be possible to compensate for those with some fine adjustments. Still, I recommend to keep an old 1.x version of Charlatan around if you need to fully preserve old projects. Sorry for the inconvenience...

## Download

[Charlatan 2.0 Windows 32/64-bit VSTi (ZIP file)](http://www.blaukraut.info/downloads/charlatan_2.0.zip)

### Latest version from 1.x (legacy)

[Charlatan 1.4.1 Windows 32/64-bit VSTi (ZIP file)](http://www.blaukraut.info/downloads/charlatan_1.4.1.zip)

## User preset banks

Please note that many of the presets are already included (maybe slightly modified) in the official releases.

- [ZN_Classics_for_Charlatan.fxb](http://www.blaukraut.info/downloads/ZN_Classics_for_Charlatan.fxb) (Zorniko)
- [ZN_Classics2_for_Charlatan.fxb](http://www.blaukraut.info/downloads/ZN_Classics2_for_Charlatan.fxb) (Zorniko)
- [Charlatan_Bank_NedK.fxb](http://www.blaukraut.info/downloads/Charlatan_Bank_NedK.fxb) (NedK)
- [Charlatan_Bank_2_Tek.zip](http://www.blaukraut.info/downloads/Charlatan_Bank_2_Tek.zip) (Teksonik)
- [alvfaria_charlatan_banks.zip](http://www.blaukraut.info/downloads/alvfaria_charlatan_banks.zip) (Alvfaria)

More banks can be found at the [KVR database](http://www.kvraudio.com/product/charlatan-by-blaukraut-engineering/downloads). If you want to share your presets, please upload them there.

## Demo tracks

Also, many exciting songs made using Charlatan exclusively are the submissions for the [KVR One Synth Challenge (OSC) 33](http://sites.google.com/site/kvrosc/osc-33).

## Support

Discussion about Charlatan takes place in the [Instruments sub-forum @ KVR audio](http://www.kvraudio.com/forum/viewforum.php?f=1). If you have questions or suggestions, post them there. You can also contact me at KVR via private message (username karrikuh). **Note that I don't take any responsibility for any damage you might experience from using my plug-ins, so use at your own risk!**
