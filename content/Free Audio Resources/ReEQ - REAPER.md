...
Cockos’ REAPER is the stupidly affordable but endlessly customizable DAW. Just one example – this free sixteen-band EQ and spectrum analyzer, created by a user in Reaper’s [JSFX](https://www.cockos.com/jsfx/)*, for free, does just about everything.
...
I’m aware my screenshots make no sense but I’m tired and – this UI is just too pretty not to make pictures with it. Take it up with my editor.
...
So the UI borrows very, very liberally from [FabFilter’s Pro-Q 3](https://www.fabfilter.com/products/pro-q-3-equalizer-plug-in), which in fact does a lot more (like surround sound, 24 bands, EQ matching). In fact if you really want to work with parametric EQ a lot, and you like this, it’s probably worth buying FabFilter’s stuff. But I like the sound and the focus in ReEQ. It’s not as comprehensive as a commercial product, but it does focus on the stuff many people will most need – and it’s fantastic that it’s free in REAPER, if you’re on a budget (or need to exchange project files with someone else without them also needing a plug-in license).

![[M2q5I2W.gif]]

![[VCXyd1m.gif]]

Check the full forum page for all the updates:

[**ReEQ and ReSpectrum, parametric equalizer and spectrum analyzer**](https://forum.cockos.com/showthread.php?t=213501) [COCKOS Forum]

You just unzip the download and drop it in the Effects folder inside your Reaper install folder. (On Windows, that’s actually Reaper > InstallData > Effects, meaning this [Mac tutorial](https://www.youtube.com/watch?v=9EegrN-gF5o) would be a little confusing, but now you know.)
...
[https://www.cockos.com/jsfx/](https://www.cockos.com/jsfx/)

Fun fact, this is one of the first stories I ever published on CDM, back in January 2005:

And the actual SDK documentation is on the REAPER site. JSFX is based on a scripting language called EEL2, so no relation to (JS) JavaScript or the [Milwaukee Journal Sentinal](https://www.jsonline.com/) or Jessica Simpson or the Jersey Shore:
...
MIT’s Senseable City Lab [looked at park environments in five cities](http://senseable.mit.edu/sonic-cities/) – San Francisco, New York, London, Milan, and Singapore. As the researchers describe it:

> “Parks bring together nature and the city. While activity in parks was the same—sometimes greater than before—what we heard changed dramatically.Across city parks, ambient sounds overtook crowd chatter, sirens cut through background noise, and music sharply declined.”
...
The MIT study’s data differs wildly by each city and park.

Check out the full report and interactive Web app:

[**http://senseable.mit.edu/sonic-cities/**](http://senseable.mit.edu/sonic-cities/)
...
[On the relation between loudness and the increased song frequency of urban birds](https://www.sciencedirect.com/science/article/abs/pii/S0003347211002983) [*Animal Behaviour*]

The urban landscape can eventually [impact birdsong itself](https://www.sciencedirect.com/science/article/abs/pii/S0003347212000541) and, as one study in Warenemunde, Germany showed, can produce intricate relationships [between human environment and song by location](http://eprints.whiterose.ac.uk/86023/7/WRRO_86023.pdf).

(Also, oddly enough, a study in *Science of the Total Environment* – awesome journal name – suggests that you can make it seem like a soundscape is quieter and more pleasant by [adding more natural sounds](https://www.sciencedirect.com/science/article/pii/S0048969719345620).)
