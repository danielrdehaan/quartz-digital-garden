...
Sophia and [Tom 7](http://tom7.org/), the devs, are pure genius.
...
And this (cool but grampa [who is that strange puppet](https://en.wikipedia.org/wiki/Homestar_Runner) I’ve never seen him on Instagram):
...
[Destroy FX updates Buffer Override, EQ Sync, Geometer, MIDI Gater, Monomaker, Polarizer, Rez Synth, Scrubby, Skidder, & Transverb – incl. 64-bit & Apple Silicon](https://www.kvraudio.com/news/destroy-fx-updates-buffer-override-eq-sync-geometer-midi-gater-monomaker-polarizer-rez-synth-scrubby-skidder-and-transverb---incl-64-bit-and-apple-silicon-52863?fbclid=IwAR3FgElWzTH3Yz5BEFa2Y1y5jDwafVyZmPlRYPELxaciErGAbktRvxohOyA&utm_source=pocket_mylist)
