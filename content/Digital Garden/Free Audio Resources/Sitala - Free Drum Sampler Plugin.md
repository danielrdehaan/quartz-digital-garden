...
![](https://decomposer.de/videos/sitala-beta.mp4)

This is a modal window.

The media could not be loaded, either because the server or network failed or because the format is not supported.

![[editable-start-and-end-points.png]]
...
![[reaper-automatic-multi-out.png]]
...
Default mappings are provided for chromatic pitches, white keys or [General MIDI](https://en.wikipedia.org/wiki/General_MIDI).
