...
If you want to suggest improvements or report a bug, please [open an issue](https://github.com/greatest-ape/OctaSine/issues). To do this, you need to create a [GitHub](https://github.com/) account. It is easier than it sounds - you only need an email address and a password.
