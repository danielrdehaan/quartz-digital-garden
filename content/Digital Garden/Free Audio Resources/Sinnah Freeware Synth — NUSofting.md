...
URL: https://nusofting.com/plugins/sinnah/
Image: sinnah_1.2.1.png
...
![[sinnah_yellow-600x358.png]]

![[sinnah_red-600x358.png]]

![[sinnah_1.1_features.png]]

![[screenshot.1.sinnah_1.1.png]]

Sinnah is a VA synth plugin, but instead of the standard subtractive resonant filter it uses a polyphonic resonant delay network.
...
**Note for Windows users**, if the VSTi plugin is not recognized you may need to go to[https://www.microsoft.com/en-us/download/details.aspx?id=30679](https://www.microsoft.com/en-us/download/details.aspx?id=30679)
