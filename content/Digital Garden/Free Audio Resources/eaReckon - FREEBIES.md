...
This series is based on the [ANALOG87 series](https://www.eareckon.com/products/analog87-series-vst-au-dynamics-channel-strip.html) which features a set of 6 high quality analog-style VST and AU effects for Windows and MacOS.
 Instead of just providing a limited demo of the [ANALOG87 series](https://www.eareckon.com/products/analog87-series-vst-au-dynamics-channel-strip.html), eaReckon would like to offer fully working free plugins using the same engine.
...
![[MIDIPolysher_110_WEB.jpg]]

MIDI Polysher is a free VST plugin primarly designed for eaReckon [BloXpander](https://www.eareckon.com/en/products/bloxpander-vst-host-for-live-performance.html) users (but it works with other compatible VST host software).
BloXpander is now provided with its own full-featured MIDI filter and therefore, [BloXpander](https://www.eareckon.com/en/products/bloxpander-vst-host-for-live-performance.html) users do not really need this plug-in anymore.
...
![[Ferret4x4_110_WEB.jpg]]

Ferret 4x4

Ferret 4x4 is a free 32/64-bit VST plug-in for Windows and a 32/64-bit VST and AU plug-in for MacOS.
It has been primarly designed to enhance the routing capabilities of eaReckon [BloXpander](https://www.eareckon.com/en/products/bloxpander-vst-host-for-live-performance.html) (but it works with other compatible host software).
...
**32/64-bit VST plug-in for Windows.32/64-bit VST/AU plug-in for MacOS.**
