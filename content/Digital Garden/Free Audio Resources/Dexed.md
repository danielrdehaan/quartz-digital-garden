...
Dexed is a multi platform, multi format plugin synth that is closely modeled on the [Yamaha DX7](http://en.wikipedia.org/wiki/Yamaha_DX7). Dexed is also a midi cartridge librarian/manager for the DX7.

Minimal documentation is available on [Dexed Wiki](https://github.com/asb2m10/dexed/wiki).
...
- [Surge Synthesizer Team](https://surge-synthesizer.github.io/) for substantial contributions like microtuning and MPE support.
...
Hint: BlackWinny from kvraudio did a great DX7 compilation named [Dexed_cart_1.0.zip](http://hsjp.eu/downloads/Dexed/Dexed_cart_1.0.zip). Simply unzip the content of this zipfile to your Cartridges directory.
