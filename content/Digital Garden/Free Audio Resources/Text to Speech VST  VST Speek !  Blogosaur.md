...
download [VST Speek 1.3 for Windows 32 bit](https://blog.wavosaur.com/download/VSTSpeek-1.3%20(32bit).zip)

download [VST Speek 1.3 for windows 64 bit](https://blog.wavosaur.com/download/VSTSpeek-1.3%20(64bit).zip)
...
v1.3:
 ...
 – fix memory leaks
 – MAC OS X version !!! => see [https://blog.wavosaur.com/text-to-speech-vst-now-for-mac-vst-speek-au-speek-audiounit/](https://blog.wavosaur.com/text-to-speech-vst-now-for-mac-vst-speek-au-speek-audiounit/)
...
v1.1:
 ...
 The original C64 software has been reverse engineered and ported to C by Sebastian Macke : [http://simulationcorner.net/index.php?page=sam](http://simulationcorner.net/index.php?page=sam)
...
**The Amiga 500 say program :**
 it used narrator & translator library to produce nice computerized robot voices ! If you are not a happy Amiga 500 owner you can use an Amiga emulator : [WinUAE](http://www.winuae.net/)

**The Commodore 64 Software Automatic Mouth (SAM) :**
 you can use the brand new VST Speek or the S.A.M simulation program (command line executable for Windows) from Sebastian Macke : [SAM for window](http://simulationcorner.net/SAM/sam_windows.zip)

**The Atari ST Speech** :
 that’s the one in U96 – Das Boot ! you can use the [Steem Atari emulator ](http://steem.atari.st/index.htm)+ [stspeech.tos](http://cd.textfiles.com/suzybatari2/wordwork/stspeech/stspeech.tos)
 Here’s a port for Windows, command line application : [stspeech.exe](https://dl.dropbox.com/u/23310861/stspeech.exe)

**Apple MacinTalk**

They were all developped by [Softvoice inc.](http://www.text2speech.com/)
...
Pleasure Game – Activez Les Plaisirs (Amnesia Robot Mix) :[http://www.bide-et-musique.com/song/11963.html Daktylus is reactivated !!!](http://www.bide-et-musique.com/song/11963.html)
...
information & download @ [http://distorqueaudio.com/plugins/azurite.html](http://distorqueaudio.com/plugins/azurite.html)
...
Download here : [http://www.vacuumsound.de/plugins.html](http://www.vacuumsound.de/plugins.html)
...
download it now ! => [http://music.service-1.de/html/wok_emonizer_vst_micro_pitch.html](http://music.service-1.de/html/wok_emonizer_vst_micro_pitch.html)
...
Information and free download @ [http://www.g200kg.com/en/software/kerovee.html](http://www.g200kg.com/en/software/kerovee.html)
...
download for free @ [http://ag-works.net/plugins.ch2.htm](http://ag-works.net/plugins.ch2.htm)