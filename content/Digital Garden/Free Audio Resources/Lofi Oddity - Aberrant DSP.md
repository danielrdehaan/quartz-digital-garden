...
![](https://aberrantdsp.com/wp-content/uploads/2023/11/LofiOdditySquare.png)

### Degradation toy box

Free

Lofi Oddity is a free toolkit for sonic destruction and experimentation. Incorporating effects from SketchCassette, Digitalis, ShapeShifter, and ????, Lofi Oddity is an immediate and easy-to-use ear candy playground.

- [Description](https://aberrantdsp.com/plugins/lofi-oddity/#tab-description)
- [Reviews (5)](https://aberrantdsp.com/plugins/lofi-oddity/#tab-reviews)
...
Lofi Oddity supports the following formats and operating systems:
...
To install Lofi Oddity onto your computer, simply run the installer package for your OS.
...
- [
    ## Bundles
    ### Mix and match for a discount
From: $24.00](https://aberrantdsp.com/plugins/bundle/) [Select options](https://aberrantdsp.com/plugins/bundle/)
- [
    ## Digitalis
    ### Digital wasteland
Rated **5.00** out of 5
$36.00](https://aberrantdsp.com/plugins/digitalis/) [Add to cart](https://aberrantdsp.com/plugins/lofi-oddity/?add-to-cart=22174)
- [
    ## SketchCassette II
    ### Cassette inspired degradation
Rated **4.90** out of 5
$36.00](https://aberrantdsp.com/plugins/sketchcassette/) [Add to cart](https://aberrantdsp.com/plugins/lofi-oddity/?add-to-cart=45)